...
export const CURRENT_PROFESSOR_NAME = 'Dr. Anh Thu';
...
export const mockMentorshipRequests: MentorshipRequest[] = [
  {
    ...
    requestMessage: 'We are working on a SAR ADC on MATLAB research project and would greatly benefit from your expertise in machine learning and AI. Our team is passionate about integrating AI models into distributed systems.',
...
export const mockMentoredGroups: MentoredGroup[] = [
  {
    ...
    maxMembers: 4,
    members: [
      { id: 4, name: 'Đinh Xuân Tiên Định', role: 'leader', joinedAt: '2024-01-20' },
      { id: 8, name: 'Nguyễn Thành Minh', role: 'member', joinedAt: '2024-02-15' },
      { id: 10, name: 'Trần Vũ Đạt', role: 'member', joinedAt: '2024-03-01' }
    ],
  ...
  },
  {
    ...
    maxMembers: 5,
    members: [
      { id: 5, name: 'Lê Công Thành Khoa', role: 'leader', joinedAt: '2024-02-01' },
      { id: 2, name: 'Trần Châu Huy', role: 'member', joinedAt: '2024-02-05' },
      { id: 7, name: 'Lê Văn Đức', role: 'member', joinedAt: '2024-02-10' },
      { id: 1, name: 'Ngô Thanh Thảo', role: 'member', joinedAt: '2024-02-15' }
    ],
  ...
  },
  {
    ...
    maxMembers: 4,
    members: [
      { id: 6, name: 'Nguyễn Văn Cường', role: 'leader', joinedAt: '2023-09-15' },
      { id: 3, name: 'Nguyễn Văn Cường', role: 'member', joinedAt: '2023-09-20' },
      { id: 4, name: 'Nguyễn Văn Cường', role: 'member', joinedAt: '2023-10-01' }
    ],
